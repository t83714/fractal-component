...
function* initSaga(sagaItem) {
    const { saga, path, namespace, acceptMulticastActionTypes } = sagaItem;
    ...
    if (this.pathRegistry.add(registeredPath, { localPathPos, namespace, acceptMulticastActionTypes }) === null) {
        throw new Error(
