...
export declare function registerSaga(saga: GeneratorFunction, sagaOptions: SagaOptions): void;
export declare function deregisterSaga(pathOrTask: string | Task): void;
export declare function registerReducer(reducer: Reducer, reducerOptions: ReducerOptions): void;
export declare function deregisterReducer(path: string): void;
export declare function registerActions(namespace: string, actions: symbol | symbol[] | object): void;
