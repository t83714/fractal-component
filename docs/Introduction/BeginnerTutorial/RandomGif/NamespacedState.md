...
i.e. If you want to mutate the component state `this.state`, you should trigger an action and mutate the component state in a `namespaced` component [reducer](https://redux.js.org/basics/reducers). You can provide this reducer  via [ManageableComponentOptions / reducer](../../../api/ManageableComponentOptions.md#reducer) method.
...
export default RandomGif;
```
> Please note: In order to make your component actions serialisable, you need to register all your component action types via [ManageableComponentOptions.actionTypes](../../../api/ManageableComponentOptions.md#option-actiontypes)
