...
In the end, you can add the `saga` into your `Component Container` via [ManageableComponentOptions / saga option](../../../api/ManageableComponentOptions.md#option-saga)
