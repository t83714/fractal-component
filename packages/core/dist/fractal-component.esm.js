...
import { take, put, select, call, fork, delay, takeEvery, cancelled, cancel as cancel$1 } from 'redux-saga/effects';
...
var takeEvery$1 = function takeEvery$$1(sagaItem, pattern, saga) {
...
function () {
  function AppContainer(options) {
    ...
    var sagaMiddleware = createSagaMiddleware(containerCreationOptions.sagaMiddlewareOptions);
