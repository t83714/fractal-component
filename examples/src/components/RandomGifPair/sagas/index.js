...
const mainSaga = function*(effects) {
    yield effects.takeLeading(actionTypes.REQUEST_NEW_GIF, function*() {
        try {
             ...
             * `io.github.t83714/NewGif` + `NewGif-xxxxxxxxx`
             * e.g. `io.github.t83714/NewGif/NewGif-4n5pxq24kpiob12og9`
             * If `relativeDispatchPath` is `../../../*`, all namespace direct parents will get action `INCREASE_COUNTER`
             */
            //--- optional second `relativeDispatchPath` parameter
            //--- specify the action dispatch path
            yield effects.put(actions.increaseCounter(), "../../../*");
        } catch (e) {
            console.log(e);
            throw e;
        }
